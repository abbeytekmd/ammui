...
export default class Renderer {
    ...
    async insertTrack(track, afterId = 0) {
        if (this.sonosDevice) {
            const { uri, title, artist, album, duration } = track;
...
<DIDL-Lite xmlns="urn:schemas-upnp-org:metadata-1-0/DIDL-Lite/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:upnp="urn:schemas-upnp-org:metadata-1-0/upnp/">
  <item id="f0002000s0" parentID="Q:0" restricted="1">
    ...
    <res protocolInfo="http-get:*:audio/mpeg:*" ${duration ? `duration="${xmlEscape(duration)}"` : ''}>${xmlEscape(uri)}</res>
  </item>
</DIDL-Lite>`.trim();
...
<DIDL-Lite xmlns="urn:schemas-upnp-org:metadata-1-0/DIDL-Lite/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:upnp="urn:schemas-upnp-org:metadata-1-0/upnp/">
  <item id="0" parentID="-1" restricted="1">
    ...
    <upnp:class>object.item.audioItem.musicTrack</upnp:class>
    <res ${duration ? `duration="${xmlEscape(duration)}"` : ''}>${xmlEscape(uri)}</res>
  </item>
</DIDL-Lite>`.trim();
...
<DIDL-Lite xmlns="urn:schemas-upnp-org:metadata-1-0/DIDL-Lite/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:upnp="urn:schemas-upnp-org:metadata-1-0/upnp/">
  <item id="0" parentID="-1" restricted="1">
    ...
    async seekTime(seconds) {
        if (this.sonosDevice) {
            try {
                return await this.sonosDevice.seek(seconds);
            } catch (err) {
